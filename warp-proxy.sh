...
AUTHOR="[Moded By JsPhantom](https://github.com/Jesanne87)"
VERSION="1.2.0"
...
#   not-forced: `curl -fsSL https://raw.githubusercontent.com/Jesanne87/combo/main/warp-proxy.sh | bash`
#   not-forced: `bash <(curl -sSL https://raw.githubusercontent.com/Jesanne87/combo/main/warp-proxy.sh)`
#   forced: `bash <(curl -sSL https://raw.githubusercontent.com/Jesanne87/combo/main/warp-proxy.sh) -yf`
# 
